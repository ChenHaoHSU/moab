...
TEST(Constructors, Default) {
  ...
  EXPECT_EQ(s.p2(), Point3_i(0, 0, 0));
}

TEST(Constructors, TwoPoints) {
  Segment3_i s(Point3_i(1, 2, 3), Point3_i(4, 5, 6));

  EXPECT_EQ(s.p1(), Point3_i(1, 2, 3));
  EXPECT_EQ(s.p2(), Point3_i(4, 5, 6));
}
...
TEST(Constructors, Copy) {
  ...
  EXPECT_EQ(s2.p1(), Point3_i(1, 2, 3));
  EXPECT_EQ(s2.p2(), Point3_i(4, 5, 6));
}
...
TEST(Mutators, SetByFourCoordinates) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(7, 8, 9));
  EXPECT_EQ(s.p2(), Point3_i(10, 11, 12));
}
...
TEST(Mutators, SetP1P2) {
  Segment3_i s(Point3_i(1, 2, 3), Point3_i(4, 5, 6));
  s.SetP2(Point3_i(10, 11, 12));
  s.SetP1(Point3_i(7, 8, 9));
...
TEST(Operations, Shift) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(2, 4, 6));
  EXPECT_EQ(s.p2(), Point3_i(5, 7, 9));
}
...
TEST(Operations, ShiftX) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(2, 2, 3));
  EXPECT_EQ(s.p2(), Point3_i(5, 5, 6));
}
...
TEST(Operations, ShiftY) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(1, 3, 3));
  EXPECT_EQ(s.p2(), Point3_i(4, 6, 6));
}
...
TEST(Operations, ShiftZ) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(1, 2, 4));
  EXPECT_EQ(s.p2(), Point3_i(4, 5, 7));
}
...
TEST(Operations, ShiftP1P2) {
  ...
  EXPECT_EQ(s.p1(), Point3_i(2, 4, 6));
  EXPECT_EQ(s.p2(), Point3_i(8, 10, 12));
}
